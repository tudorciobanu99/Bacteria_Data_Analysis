...
@author: ciobanutudor, marinanocera, mihainipomici
"""
...
dataFiltered = np.array([False, False])   # Specifies if the filters have been applied. The first value of the array deals
                                          # with the bacteria filter, while the second one deals with the growth rate filter
fullData = None   # This variable will eventually contain the data loaded from the dataLoad function
currentData = None   # This variable will eventually contain the data in current use
...
print('\nWelcome to Bacteria Analysis interactive program!')
choice = printMenu()
